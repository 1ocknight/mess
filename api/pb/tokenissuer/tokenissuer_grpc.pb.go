...
const (
	TokenVerifier_Verify_FullMethodName = "/tokenissuer.TokenVerifier/Verify"
)
...
func (c *tokenVerifierClient) Verify(ctx context.Context, in *VerifyRequest, opts ...grpc.CallOption) (*VerifyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyResponse)
	err := c.cc.Invoke(ctx, TokenVerifier_Verify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedTokenVerifierServer must be embedded to have
...
func (UnimplementedTokenVerifierServer) Verify(context.Context, *VerifyRequest) (*VerifyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Verify not implemented")
}
func (UnimplementedTokenVerifierServer) mustEmbedUnimplementedTokenVerifierServer() {}
func (UnimplementedTokenVerifierServer) testEmbeddedByValue()                       {}
...
func RegisterTokenVerifierServer(s grpc.ServiceRegistrar, srv TokenVerifierServer) {
	// If the following call pancis, it indicates UnimplementedTokenVerifierServer was
...
func _TokenVerifier_Verify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenVerifierServer).Verify(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TokenVerifier_Verify_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenVerifierServer).Verify(ctx, req.(*VerifyRequest))
	}
...
var TokenVerifier_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tokenissuer.TokenVerifier",
